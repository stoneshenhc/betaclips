...
class SheetsAccessValidator:
    ...
    def validate_access(self, spreadsheetid) -> dict:
        ...
        for perm in permissions:
            if perm.get('emailAddress', '') == 'writer@betaclips.iam.gserviceaccount.com':
                ...
                if role in self.VALID_ROLES:
                    ...
                    return {'valid': False, 'msg': f"Current role is {role}, but needs at least writer"}
        return {'valid': False, 'msg': "Spreadsheet file does not exist or is not shared with service account"}
